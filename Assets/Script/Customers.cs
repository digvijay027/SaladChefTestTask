...
public class Customers : MonoBehaviour, IInteractable, ISpawnable {
	...
	private void Start(){
		HasEaten = true;
		playerController = GameObject.FindGameObjectWithTag(Tags.PLAYER_MANAGER).GetComponent<PlayerController>();
	}
